    ...
    <>
      <section className="py-16">
        <div className="mx-auto max-w-6xl px-6">
          <SectionHeading eyebrow="Principal investigators" title={team.leadsTitle} />
          ...
          <div className="mt-12">
            <SectionHeading eyebrow="Co-investigators" title={team.coInvestigatorsTitle} />
      ...
      <section className="border-t border-mist-200 bg-mist-50 py-16">
        <div className="mx-auto max-w-6xl px-6">
          <SectionHeading
            eyebrow={team.partnersEyebrow}
            title={team.partnersTitle}
            lead={team.partnersLead}
          />
          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {partners.map((p, i) => (
